...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-6 bg bg-light mt-2 mb-2">
        <!--mt=margin-top    ml=margin-left    mr=margin-right  mb= margin-bottom-->
        <h1>INSCRIPTION</h1>
    </div>
    <div class="col-md-6 float-right">
  <img src="ic-login.png" class="rounded rounded-circle float-right" height='80px' alt="">
  <!--rounded-circle c pour rendre rond l'image-->
    </div>
        </div>
        <form action="" method="post">
            <div class="form-group col-md-10 mx-auto">
              ...
              <button class="btn btn-outline-dark" type='submit' name='valider'>Creer un compte</button>
